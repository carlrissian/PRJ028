...
class StoreCommercialGroupTranslationsCommand
{
    /**
     * @var int
     */
     ...
     * @param $userId
     */
    public function __construct(int $commercialGroupId, int $languageId, string $languageCode, string $translation, bool $default, $userId)
    {
