...
namespace Distribution\Acriss\Infrastructure;
...
use Distribution\Acriss\Domain\AcrissGetByResponse;

class AcrissRepositorySap extends RepositoryHelper implements AcrissRepository
{
