<template>
    <fragment>
        ...
        <acriss-form v-if="selectList" :action="CREATE_ACTION" :select-list="selectList" />
    </fragment>
</template>
...
import { CREATE_ACTION } from "../../components/acriss/form/AcrissForm.vue";

export default {
    name: "AcrissCreatePage",
    components: {
        AcrissForm,
    },
    data() {
