...
Encore
    ...
    .addEntry('utilities', './assets/assets/js/utilities.js')
    .addEntry('bootstrap-table-export',
            [
                './assets/assets-datatable/js/tableExport.min.js',
                './node_modules/bootstrap-table/dist/extensions/export/bootstrap-table-export.js'
            ])
    .addEntry('bootstrap-fixed-columns', './assets/extensions-datatable/fixed-columns/bootstrap-table-fixed-columns.js')
    .addStyleEntry('bootstrap-table-fixed', './assets/extensions-datatable/fixed-columns/bootstrap-table-fixed-columns.css')
